...
| `05_schematic_rev1_execution_plan.md` | Load-on-demand Rev1 schematic drawing plan and output constraints for fast first-version work. |
...
For Rev1 schematic drawing, schedule adjustment, or first-pass schematic checking, also provide `05_schematic_rev1_execution_plan.md`.
