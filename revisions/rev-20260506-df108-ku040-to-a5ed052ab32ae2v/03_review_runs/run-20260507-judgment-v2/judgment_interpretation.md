...
|---|---|---|---|---|
| constraint_checker | CONSTRAINT-NO-INPUT | INFO | /home/ubuntu/hardware-projects/prj/DF108/revisions/rev-20260506-df108-ku040-to-a5ed052ab32ae2v/03_review_runs/run-20260507-judgment-v2/runtime_repo/data/DF108 | 未找到可检查的设计约束，约束冲突检查已跳过。提供 requirements.yaml 或 pipeline_result.design_constraints 后会启用。 |
